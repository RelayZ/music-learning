<template>
    <div class="table">
        ...
        <!-- :data=data是为了翻页功能  表中的数据是通过prop属性弄出来的  :data属性也就是整个表格的数据 -->
...
export default {
    ...
    methods:{
        ...
        //添加用户
        addConsumer(){
            // 就是上面那个有refs属性的   可以看做id   匿名函数是校验结果
            this.$refs['registerForm'].validate(valid =>{
                if(valid){
                    ...
                    this.notify("请确保填写正确且完整再提交","error")
                }
            })
